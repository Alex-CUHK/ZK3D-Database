...
impl<E: Pairing, QAP: R1CSToQAP> Groth16<E, QAP> {
    ...
    fn create_proof_with_assignment(
        ...
        let h_assignment = cfg_into_iter!(h)
            ...
            .collect::<Vec<_>>();
        eprintln!(
            "ZK3D_PROFILE,MSM,h_query,points={},scalars={}",
            pk.h_query.len(),
            h_assignment.len()
        );
        ...
        eprintln!(
            "ZK3D_PROFILE,MSM,l_query,points={},scalars={}",
            pk.l_query.len(),
            aux_assignment.len()
        );
        ...
        let g_a = Self::calculate_coeff("a_query_g1", r_g1, &pk.a_query, pk.vk.alpha_g1, &assignment);
        ...
        let g1_b = if !r.is_zero() {
            ...
            let g1_b = Self::calculate_coeff("b_query_g1", s_g1, &pk.b_g1_query, pk.beta_g1, &assignment);
        ...
        let g2_b = Self::calculate_coeff("b_query_g2", s_g2, &pk.b_g2_query, pk.vk.beta_g2, &assignment);
        let r_g1_b = g1_b * &r;
        drop(assignment);
        ...
        G::Group: VariableBaseMSM<MulBase = G>,
    {
        let el = query[0];
        eprintln!(
            "ZK3D_PROFILE,MSM,{},points={},scalars={}",
            label,
            query[1..].len(),
            assignment.len()
        );
