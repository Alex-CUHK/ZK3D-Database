...
impl R1CSToQAP for LibsnarkReduction {
    ...
    fn witness_map_from_matrices<F: PrimeField, D: EvaluationDomain<F>>(
        ...
        eprintln!("ZK3D_PROFILE,IFFT,a,elements={}", a.len());
        domain.ifft_in_place(&mut a);
        eprintln!("ZK3D_PROFILE,IFFT,b,elements={}", b.len());
        domain.ifft_in_place(&mut b);

        let coset_domain = domain.get_coset(F::GENERATOR).unwrap();

        eprintln!("ZK3D_PROFILE,FFT,a,elements={}", a.len());
        coset_domain.fft_in_place(&mut a);
        eprintln!("ZK3D_PROFILE,FFT,b,elements={}", b.len());
        ...
        eprintln!("ZK3D_PROFILE,IFFT,c,elements={}", c.len());
        domain.ifft_in_place(&mut c);
        eprintln!("ZK3D_PROFILE,FFT,c,elements={}", c.len());
        ...
        eprintln!("ZK3D_PROFILE,IFFT,ab,elements={}", ab.len());
